...
namespace DAPM.ClientApi.Controllers
{
    ...
    public class PipelineController : ControllerBase
    {
        ...
        public async Task<ActionResult<Guid>> GetPipelineById(Guid organizationId, Guid repositoryId, Guid pipelineId, [FromQuery] Guid owner, [FromQuery] string ownerType, [FromQuery] Guid? userGroup)
        {
        ...
        public async Task<ActionResult<Guid>> CreatePipelineExecutionInstance(Guid organizationId, Guid repositoryId, Guid pipelineId, [FromQuery] Guid owner, [FromQuery] string ownerType, [FromQuery] Guid? userGroup)
        {
            Guid id = _pipelineService.CreatePipelineExecution(organizationId, repositoryId, pipelineId, owner, ownerType, userGroup);
        ...
        public async Task<ActionResult<ApiResponse>> PostStartCommand(Guid organizationId, Guid repositoryId, Guid pipelineId, Guid executionId, [FromQuery] Guid owner, [FromQuery] string ownerType, [FromQuery] Guid? userGroup)
        {
            try
            {
                Guid id = _pipelineService.PostStartCommand(organizationId, repositoryId, pipelineId, executionId, owner, ownerType, userGroup);
        ...
        public async Task<ActionResult<Guid>> GetPipelineExecutionStatus(Guid organizationId, Guid repositoryId, Guid pipelineId, Guid executionId, [FromQuery] Guid owner, [FromQuery] string ownerType, [FromQuery] Guid? userGroup)
        {
